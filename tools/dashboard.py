...
def show_training_dashboard():
        ...
        try:
            ...
            if losses:
                ...
                if len(losses) > 100:
                    ...
                    trend_dir = "down" if recent_trend < 0 else "up" if recent_trend > 0 else "flat"
                    print(f"   Recent Trend ({trend_dir}): {recent_trend:+.4f}")
    ...
    print(f"   Network:        {NETWORK_HIDDEN_LAYERS}")
